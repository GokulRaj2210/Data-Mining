...
X_1, y_1 = make_blobs(n_samples=100, center_box=(5,5), cluster_std=2, random_state=0)
X_2, y_2 = make_blobs(n_samples=100, center_box=(-5,5), cluster_std=2, random_state=0)
X_3, y_3 = make_blobs(n_samples=100, center_box=(-5,-5), cluster_std=2, random_state=0)
X_4, y_4 = make_blobs(n_samples=100, center_box=(5,-5), cluster_std=2, random_state=0)
